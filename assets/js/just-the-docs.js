(function (jtd, undefined) {
    ...
    function initNavBar() {
      return fetch("https://osadi.github.io/electricity/nav.html").then(function (response) {
    ...
    function initSearch() {
      ...
      request.open("GET", "https://osadi.github.io/electricity/assets/js/search-data.json", true);
    ...
    jtd.setTheme = function (theme) {
      ...
      cssFile.setAttribute(
        "href",
        'https://osadi.github.io/electricity/assets/css/just-the-docs-' + theme + ".css"
      );
    };
